    ...
    <Content>
      ...
      <div className={styles['container']}>
        <Card
          title="Discord"
          value="Click Me!"
          href="https://discord.com/invite/ARu4hr6hJw"
        />
        <Card title="Email" value="business@zerosync.tech"/>
        <Card
          title="Github"
          value="Click Me!"
          href="https://github.com/ZeroDiscord"
        />
        <Card
          title="Youtube"
          value="Click Me!"
        ...
        <Card
          title="Twitter"
          value="Click Me!"
          href="https://twitter.com/RestInPeaceZero"
        />
      </div>
    </Content>
  );
